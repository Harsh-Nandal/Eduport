...
const pagesRoutes = [
  ...
  {
    path: "/auth/sign-up/step2",
    name: "auth.sign-up-step2",
    meta: {
      title: setTitle("Sign Up")
    },
    component: () => import("@/views/pages/auth/sign-up-step2.vue"),
  },
  {
...
const accountsRoutes = [
  ...
  {
    path: "/instructor/create-profile",
    name: "instructor.create.profile",
    meta: {
      title: setTitle("Edit Profile")
    },
    component: () => import("@/views/accounts/instructor/create-profile/new-profile.vue"),
  },
  {
